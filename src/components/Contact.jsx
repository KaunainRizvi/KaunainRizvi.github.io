...
export const Contact = () => {
    ...
    return <div id='contact' style={{ '--bglightproject': light ? "#edf2f8" : "#0a192f", '--plight': light ? 'black' : 'white', '--namelight': light ? "#dc143c" : "#64ffda", '--rolelight': light ? "white" : "#152235" }}>
            ...
            <div id='contactDetSec'>
                ...
                <div>
                    <div className='contactOption'>
                        ...
                        <a href='tel:8822076879'>+91 86686 71635</a>
                    </div>
                    <div className='contactOption'>
                        <MdEmail className='contactIcon' />
                        <a href='mailto:krizvibusiness@gmail.com'>krizvibusiness@gmail.com</a>
                    </div>
                    <div className='contactOption'>
                        <BsGithub className='contactIcon' />
                        <a href='https://github.com/KaunainRizvi' target='_blank'>GitHub</a>
                    </div>
                    <div className='contactOption'>
                        <BsLinkedin className='contactIcon' />
                        <a href='https://www.linkedin.com/in/kaunain-rizvi' target='_blank'>LinkedIn</a>
                    </div>
                    <div className='contactOption'>
        ...
        <div id='creator'>
            <p>Designed & Built by Kaunain Rizvi.</p>
        </div>
    </div>
}